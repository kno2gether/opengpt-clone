...
from .trendingTitles import TrendingTitlesQueryRun, TrendingTitlesInput, TrendingTitlesAPIWrapper
...
@lru_cache(maxsize=1)
def _get_trending_titles():
    api_key = os.getenv("TRENDING_TITLES_API_KEY")
    trending_titles_api_wrapper = TrendingTitlesAPIWrapper(api_key=api_key)
    return TrendingTitlesQueryRun(api_wrapper=trending_titles_api_wrapper)
...
TOOLS = {
    ...
    AvailableTools.TRENDING_TITLES: _get_trending_titles,
}
